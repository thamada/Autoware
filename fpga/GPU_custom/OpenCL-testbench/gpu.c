...
void gpu(signed int *gmem, signed int *group_id_2e_x, signed int *group_id_2e_y, signed int *group_id_2e_z, signed int *global_offset_2e_x, signed int *global_offset_2e_y, signed int *global_offset_2e_z, signed int *x, signed int *y, signed int *z) {
  signed int llvm_cbe_tid4965_2e_i_2e_i[3];    /* Address-exposed local */
  ...
  signed int *llvm_cbe_tid4965_2e_sub_2e_i_2e_i;
  signed int *llvm_cbe_tid51_2e_i_2e_i;
  signed int *llvm_cbe_tid52_2e_i_2e_i;
   char *llvm_cbe_CI_2e_i_2e_i;
   char *llvm_cbe_tmp__77;
   char *llvm_cbe_CI30_2e_i_2e_i;
   char *llvm_cbe_tmp__78;
  unsigned int llvm_cbe_indvar_2e_reg2mem62_2e_0_2e_i_2e_i;
  unsigned int llvm_cbe_indvar_2e_reg2mem62_2e_0_2e_i_2e_i__PHI_TEMPORARY;
  unsigned int llvm_cbe_tmp__79;
  signed int *llvm_cbe_tmp__80;
  unsigned int llvm_cbe_tmp__81;
  unsigned int llvm_cbe_tid_2e_dim_2e_i_2e_i;
  unsigned int llvm_cbe_idx_2e_0_2e_reg2mem_2e_0_2e_i_2e_i;
  ...
  float llvm_cbe__2e_reg2mem_2e_0_2e_i_2e_i;
  bool llvm_cbe_or_2e_cond_2e_i_2e_i;
  ...
  *((unsigned long long volatile*)(&llvm_cbe__2e_0_2e_12)) = llvm_cbe_tmp__76;
  llvm_cbe_tid4965_2e_sub_2e_i_2e_i = (signed int *)(&llvm_cbe_tid4965_2e_i_2e_i[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 3
#endif
]);
...
#ifdef AESL_BC_SIM
  assert(((signed int )0u) < 3 && "Write access out of array 'tid4965.i.i' bound?");

#endif
  *llvm_cbe_tid4965_2e_sub_2e_i_2e_i = 0u;
  llvm_cbe_tid51_2e_i_2e_i = (signed int *)(&llvm_cbe_tid4965_2e_i_2e_i[(((signed int )1u))
#ifdef AESL_BC_SIM
 % 3
#endif
]);
...
#ifdef AESL_BC_SIM
  assert(((signed int )1u) < 3 && "Write access out of array 'tid4965.i.i' bound?");

#endif
  *llvm_cbe_tid51_2e_i_2e_i = 0u;
  llvm_cbe_tid52_2e_i_2e_i = (signed int *)(&llvm_cbe_tid4965_2e_i_2e_i[(((signed int )2u))
#ifdef AESL_BC_SIM
 % 3
#endif
]);
...
#ifdef AESL_BC_SIM
  assert(((signed int )2u) < 3 && "Write access out of array 'tid4965.i.i' bound?");
...
llvm_cbe_for_2e_header_2e_i_2e_i:
  llvm_cbe_indvar_2e_reg2mem62_2e_0_2e_i_2e_i = (unsigned int )llvm_cbe_indvar_2e_reg2mem62_2e_0_2e_i_2e_i__PHI_TEMPORARY;
...
llvm_cbe__Z21async_work_grou25_2e_i_2e_i:
 ...
 % 64
  ...
  llvm_cbe_gep_idx_2e_i_2e_i = (unsigned int )llvm_cbe_idx_2e_0_2e_reg2mem_2e_0_2e_i_2e_i & 1073741823u;
  ...
  llvm_cbe_tmp__118 = (signed int *)(&gmem[(((signed int )llvm_cbe_arg_z_2e_i_2e_0_2e_sum))]);
  llvm_cbe_val_2e_i_2e_i = (unsigned int )(llvm_cbe_val_2e_i_2e_i__BITCAST_TEMPORARY.Float = llvm_cbe_tmp__117, llvm_cbe_val_2e_i_2e_i__BITCAST_TEMPORARY.Int32);
  *llvm_cbe_tmp__118 = llvm_cbe_val_2e_i_2e_i;
  llvm_cbe_indvar_2e_inc_2e_reg2mem_2e_0_2e_i_2e_i = (unsigned int )((unsigned int )(llvm_cbe_indvar_2e_reg2mem62_2e_0_2e_i_2e_i&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
  _ssdm_SpecLoopFlatten(0u, ( char (*)[1])(*(&aesl_internal_str)));
  llvm_cbe_indvar_2e_reg2mem62_2e_0_2e_i_2e_i__PHI_TEMPORARY = (unsigned int )llvm_cbe_indvar_2e_inc_2e_reg2mem_2e_0_2e_i_2e_i;   /* for PHI node */
  goto llvm_cbe_for_2e_header_2e_i_2e_i;

llvm_cbe__Z21async_work_grou24_2e_rentry_2e_i_2e_i:
...
#ifdef AESL_BC_SIM
  if (!(((signed int )0u) < 3)) fprintf(stderr, "%s:%d: warning: Read access out of array 'tid4965.i.i' bound?\n", __FILE__, __LINE__);

#endif
  llvm_cbe_tid_2e_dim_2e_i_2e_i = (unsigned int )*llvm_cbe_tid4965_2e_sub_2e_i_2e_i;
 ...
 % 64
  ...
  llvm_cbe_tmp__102 = (float )((float )(llvm_cbe_tmp__101 + 0x1.921cacp1));
 ...
 % 64
  ...
  llvm_cbe_tmp__107 = (float )((float )(llvm_cbe_tmp__106 + 0x1.82db34p-77));
  llvm_cbe_tmp__108 = (float )((float )(llvm_cbe_tmp__103 / llvm_cbe_tmp__107));
  llvm_cbe__2e_reg2mem_2e_0_2e_i_2e_i = (float )((float )(llvm_cbe_tmp__108 * llvm_cbe_tmp__108));
  llvm_cbe_or_2e_cond_2e_i_2e_i = (bool )(((llvm_fcmp_ogt(llvm_cbe__2e_reg2mem_2e_0_2e_i_2e_i, 0x1.99999ap-4)) & (llvm_fcmp_olt(llvm_cbe__2e_reg2mem_2e_0_2e_i_2e_i, 0x1.4p3)))&1);
  if (llvm_cbe_or_2e_cond_2e_i_2e_i) {
    goto llvm_cbe_tmp__120;
  } else {
    goto llvm_cbe__Z21async_work_grou25_2e_i_2e_i;
  }
